...
public class ShowSpecUserRent implements Operation{
	...
	public void Operation(Database database, JFrame f, User user) {
		...
		JFrame frame = new JFrame("Show User's Rent");
		frame.setSize(600,260);
		frame.setLocationRelativeTo(f);
		frame.getContentPane().setBackground(new Color(250,206,27));
		frame.setLayout(new BorderLayout());
		
		JLabel title = new JLabel("Show User's Rent",35);
...
//				if(accType==0) {
//					System.out.println("ID: "+rs0.getInt("ID"));
//					System.out.println("First Name: "+rs0.getString("FirstName"));
//					System.out.println("Last Name: "+rs0.getString("LastName"));
//					System.out.println("Email: "+rs0.getString("Email"));
//					System.out.println("Phone Number: "+rs0.getString("PhoneNumber"));
//					System.out.println("--------------------------------");
//				}
			}
...
//			e.printStackTrace();
		...
		confirm.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				new ShowUserRent(Integer.parseInt(id.getSelectedItem().toString())).Operation(database, f, user);
				frame.dispose();
			}
